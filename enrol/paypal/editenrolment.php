...
/**
 * Paypal user enrolment edit script. Based on Self enrollment
 *
 * This page allows the current user to edit a paypal user enrolment.
...
require_once("$CFG->dirroot/enrol/paypal/editenrolment_form.php"); // Forms for this page
...
require_capability("enrol/paypal:manage", get_context_instance(CONTEXT_COURSE, $course->id, MUST_EXIST));
...
$url = new moodle_url('/enrol/paypal/editenrolment.php', $returnurl->params());
...
if (!$plugin->allow_manage($instance) || $instance->enrol != 'paypal' || !($plugin instanceof enrol_paypal_plugin)) {
